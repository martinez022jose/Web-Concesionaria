...
ex.set('views', path.join(__dirname, 'src/views')); // Especificamos ruta de views
...
//Routes
ex.use(require('./src/routes/routes.js'));

//Create folder -g / Se entrega al navegador, para mejorar el frontend
ex.use(express.static(path.join(__dirname, 'src/public')));
